...
from rule_engine import get_call_data,main_rule
# get_schedule,get_device,get_latlng,get_temp,get_rule_id,get_assetId,get_asset
...
def index():
    site = request.args.get('site',default = 1001, type = int)
    account = request.args.get('account',default = 1, type = int)
    print(site,account,type(site),type(account))
    ...
    res = main_rule(account,site,int(device_type),temp_url,api_key)
...
@app.route('/get_hourwise_results')
def res():
    site = request.args.get('site',default = 1001, type = int)
    account = request.args.get('account',default = 1, type = int)
